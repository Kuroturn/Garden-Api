...
/**
 * Network handling class for GardenApi.<br>
 * Handles packet registration and some networking functions
 */
public final class GardenApiNetwork {
	private static final String VER = "1";
    private static final SimpleChannel PACKET_CHANNEL = NetworkRegistry.newSimpleChannel(ResourceLocation.fromNamespaceAndPath(GardenApi.MOD_ID, "main"), () -> VER, clientVer -> true, VER::equals);
	...
	/**
	 * Send a packet using GardenApi's packet channel
	 */
