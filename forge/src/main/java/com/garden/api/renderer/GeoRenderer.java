...
import com.garden.api.cache.object.*;
...
import com.garden.api.core.object.Color;
...
/**
 * Base interface for all GardenApi renderers.<br>
 */
public interface GeoRenderer<T extends GeoAnimatable> {
	 ...
	 *     <li>For {@link com.garden.api.animatable.GeoBlockEntity Tile Entities} and {@link com.garden.api.animatable.GeoItem Items}, it's currently unused</li>
	 * </ul>
	 ...
	 * All GardenApi renderers should immediately defer their respective default {@code render} calls to this, for consistent handling
	 */
