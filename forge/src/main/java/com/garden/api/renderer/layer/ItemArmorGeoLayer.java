package com.garden.api.renderer.layer;
...
/**
 * Builtin class for handling dynamic armor rendering on GardenApi entities
 * <p>
 * Supports both {@link GeoItem GardenApi} and {@link ArmorItem Vanilla} armor models
 * <p>
...
public class ItemArmorGeoLayer<T extends LivingEntity & GeoAnimatable> extends GeoRenderLayer<T> {
	...
	/**
	 * Get the cube from the source part that GardenApi should use as the reference cube for scaling the GardenApi bone
	 * for rendering.
	 * <p>
