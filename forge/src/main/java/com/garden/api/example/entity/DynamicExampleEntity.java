...
/**
 * Example extended-support entity for GardenApi advanced rendering
...
public class DynamicExampleEntity extends PathfinderMob implements GeoEntity {
	...
	protected InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		player.sendSystemMessage(Component.translatable("entity." + GardenApi.MOD_ID + ".mutant_zombie.equip", stack.getDisplayName()));
