...
import com.garden.api.example.client.model.entity.MutantZombieModel;
...
import com.garden.api.renderer.layer.BlockAndItemGeoLayer;
import com.garden.api.renderer.layer.ItemArmorGeoLayer;
...
public class MutantZombieRenderer extends DynamicGeoEntityRenderer<DynamicExampleEntity> {
    ...
    protected final ResourceLocation CAPE_TEXTURE = ResourceLocation.fromNamespaceAndPath(GardenApi.MOD_ID, "textures/entity/dynamic_entity_cape.png");
