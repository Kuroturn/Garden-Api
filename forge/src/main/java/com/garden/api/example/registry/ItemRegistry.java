...
import com.garden.api.example.item.*;
import com.garden.api.GardenApi;

public final class ItemRegistry {
	public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, GardenApi.MOD_ID);
	public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, GardenApi.MOD_ID);
	...
	public static final RegistryObject<CreativeModeTab> GECKOLIB_TAB = TABS.register("garden_api_examples", () -> CreativeModeTab.builder()
			.title(Component.translatable("itemGroup." + GardenApi.MOD_ID + ".garden_api_examples"))
