...
import com.garden.api.cache.AnimatableIdCache;
...
import com.garden.api.core.animation.ContextAwareAnimatableManager;
...
/**
 * The {@link com.garden.api.core.animatable.GeoAnimatable GeoAnimatable} interface specific to {@link net.minecraft.world.item.Item Items}.
 ...
 * @see <a href="https://github.com/bernie-g/garden_api/wiki/Armor-Animations">GardenApi Wiki - Armor Animations</a>
 */
public interface GeoItem extends SingletonGeoAnimatable {
	static final String ID_NBT_KEY = "GardenApiID";
