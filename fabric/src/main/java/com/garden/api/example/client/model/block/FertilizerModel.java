...
public class FertilizerModel extends DefaultedBlockGeoModel<FertilizerBlockEntity> {
	private final ResourceLocation BOTARIUM_MODEL = buildFormattedModelPath(new ResourceLocation(GardenApi.MOD_ID, "botarium"));
	private final ResourceLocation BOTARIUM_TEXTURE = buildFormattedTexturePath(new ResourceLocation(GardenApi.MOD_ID, "botarium"));
	private final ResourceLocation BOTARIUM_ANIMATIONS = buildFormattedAnimationPath(new ResourceLocation(GardenApi.MOD_ID, "botarium"));

	public FertilizerModel() {
		super(new ResourceLocation(GardenApi.MOD_ID, "fertilizer"));
	}
