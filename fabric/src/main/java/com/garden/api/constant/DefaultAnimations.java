 ...
 * Additionally, it encourages use of cached {@link com.garden.api.core.animation.RawAnimation RawAnimations}, to reduce overheads.
 */
public final class DefaultAnimations {
	 ...
	 * Recommended:
	 * <ul>
	 *     <li>{@link com.garden.api.animatable.GeoEntity GeoEntity}: state -> animatable</li>
	 *     <li>{@link com.garden.api.animatable.GeoBlockEntity GeoBlockEntity}: state -> animatable</li>
	 *     <li>{@link com.garden.api.animatable.GeoReplacedEntity GeoReplacedEntity}: state -> state.getData(DataTickets.ENTITY)</li>
	 *     <li>{@link com.garden.api.animatable.GeoItem GeoItem}: state -> state.getData(DataTickets.ITEMSTACK)</li>
