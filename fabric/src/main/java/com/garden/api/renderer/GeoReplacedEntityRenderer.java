package com.garden.api.renderer;
...
import com.garden.api.cache.texture.AnimatableTexture;
...
import com.garden.api.event.GeoRenderEvent;
...
import com.garden.api.renderer.layer.GeoRenderLayersContainer;
import com.garden.api.util.RenderUtils;

import java.util.List;

/**
 * An alternate to {@link GeoEntityRenderer}, used specifically for replacing existing non-garden_api
 * entities with garden_api rendering dynamically, without the need for an additional entity class
 */
public class GeoReplacedEntityRenderer<E extends Entity, T extends GeoAnimatable> extends EntityRenderer<E> implements GeoRenderer<T> {
	...
	/**
	 * Sets a scale override for this renderer, telling GardenApi to pre-scale the model
	 */
