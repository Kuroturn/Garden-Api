package com.garden.api.loading;
...
public final class FileLoader {
	/**
	 * Load up and deserialize an animation json file to its respective {@link com.garden.api.core.animation.Animation} components
	...
	public static String getFileContents(ResourceLocation location, ResourceManager manager) {
		try (InputStream inputStream = manager.getResourceOrThrow(location).open()) {
			...
			GardenApi.LOGGER.error("Couldn't load " + location, e);
