package com.garden.api.loading.object;
...
import com.garden.api.loading.json.raw.*;
 ...
 * Handled by default by GardenApi, but custom implementations may be added by other mods for special needs
 */
public interface BakedModelFactory {
	 ...
	 * It is recommended you don't call this directly, and instead call it via {@link GardenApiUtil#addCustomBakedModelFactory}
