package com.garden.api.loading.json.typeadapter;
...
import com.garden.api.core.keyframe.BoneAnimation;
import com.garden.api.core.keyframe.Keyframe;
import com.garden.api.core.keyframe.KeyframeStack;
import com.garden.api.core.molang.MolangException;
import com.garden.api.core.molang.MolangParser;
import com.garden.api.core.molang.expressions.MolangValue;
import com.garden.api.loading.object.BakedAnimations;
import com.garden.api.util.JsonUtil;
...
/**
 * {@link com.google.gson.Gson} {@link JsonDeserializer} for {@link com.garden.api.loading.object.BakedAnimations}.<br>
	...
	public BakedAnimations deserialize(JsonElement json, Type type, JsonDeserializationContext context) throws JsonParseException {
		...
		for (Map.Entry<String, JsonElement> entry : obj.entrySet()) {
			try {
				...
				GardenApi.LOGGER.error("Unable to parse animation: " + entry.getKey());
				ex.printStackTrace();
			}
		}
