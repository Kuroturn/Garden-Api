...
public non-sealed interface StatelessGeoSingletonAnimatable extends StatelessAnimatable, SingletonGeoAnimatable {
    ...
    default void playAnimation(RawAnimation animation, Entity relatedEntity, long instanceId) {
        if (relatedEntity.level().isClientSide) {
            ...
            GardenApiNetwork.sendToTrackingEntityAndSelf(new StatelessSingletonPlayAnimPacket(GardenApiNetwork.getSyncedSingletonAnimatableId(this), instanceId, animation), relatedEntity);
        }
    }
    ...
    default void stopAnimation(String animation, Entity relatedEntity, long instanceId) {
        if (relatedEntity.level().isClientSide) {
            ...
            GardenApiNetwork.sendToTrackingEntityAndSelf(new StatelessSingletonStopAnimPacket(GardenApiNetwork.getSyncedSingletonAnimatableId(this), instanceId, animation), relatedEntity);
        }
    }
