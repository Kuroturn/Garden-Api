...
public interface SingletonGeoAnimatable extends GeoAnimatable {
    ...
    default <D> void syncAnimData(long instanceId, SerializableDataTicket<D> dataTicket, D data, Entity entityToTrack) {
        GardenApiNetwork.sendToTrackingEntityAndSelf(new AnimDataSyncPacket<>(GardenApiNetwork.getSyncedSingletonAnimatableId(this), instanceId, dataTicket, data), entityToTrack);
    }
    ...
    default <D> void triggerAnim(Entity relatedEntity, long instanceId, @Nullable String controllerName, String animName) {
        if (relatedEntity.level().isClientSide()) {
            ...
            GardenApiNetwork.sendToTrackingEntityAndSelf(new AnimTriggerPacket(GardenApiNetwork.getSyncedSingletonAnimatableId(this), instanceId, controllerName, animName), relatedEntity);
        }
    }
     ...
     */
    default void triggerAnim(long instanceId, @Nullable String controllerName, String animName, GardenApiNetwork.IPacketCallback packetCallback) {
        GardenApiNetwork.sendWithCallback(new AnimTriggerPacket(GardenApiNetwork.getSyncedSingletonAnimatableId(this), instanceId, controllerName, animName), packetCallback);
    }
    ...
    default void stopTriggeredAnim(Entity relatedEntity, long instanceId, @Nullable String controllerName, @Nullable String animName) {
        if (relatedEntity.level().isClientSide()) {
            ...
            GardenApiNetwork.sendToTrackingEntityAndSelf(new StopTriggeredSingletonAnimPacket(GardenApiNetwork.getSyncedSingletonAnimatableId(this), instanceId, controllerName, animName), relatedEntity);
        }
    }
