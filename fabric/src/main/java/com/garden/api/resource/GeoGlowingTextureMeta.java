package com.garden.api.resource;
...
/**
 * Metadata class that stores the data for GardenApi's {@link com.garden.api.renderer.layer.AutoGlowingGeoLayer emissive texture feature} for a given texture
 */
