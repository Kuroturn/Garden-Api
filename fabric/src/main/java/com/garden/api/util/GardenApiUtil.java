...
import com.garden.api.core.animation.EasingType;
import com.garden.api.core.animatable.instance.AnimatableInstanceCache;
import com.garden.api.core.animatable.instance.InstancedAnimatableInstanceCache;
...
/**
 * Helper class for various GardenApi-specific functions.
 */
public final class GardenApiUtil {
	/**
	 ...
	 * Recommended to use {@link GardenApiUtil#createInstanceCache(GeoAnimatable)} unless you know what you're doing.
	 * @param animatable The animatable object
	...
	/**
	 * Register a custom {@link com.garden.api.core.animation.Animation.LoopType} with GardenApi,
	...
	/**
	 * Register a custom {@link com.garden.api.core.animation.EasingType} with GardenApi,
	...
	/**
	 * Register a custom {@link com.garden.api.loading.object.BakedModelFactory} with GardenApi,
	...
	/**
	 * Register a custom {@link SerializableDataTicket} with GardenApi for handling custom data transmission.<br>
	 * NOTE: You do not need to register non-serializable {@link com.garden.api.core.object.DataTicket DataTickets}.
	 * <p>
