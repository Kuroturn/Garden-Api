...
import com.garden.api.utils.RaycastUtils;
...
import com.garden.api.config.ReverbParams;
import com.garden.api.debug.RaycastRenderer;
import com.garden.api.profiling.TaskProfiler;
import com.garden.api.profiling.TaskProfiler.TaskProfilerHandle;
...
public class SoundPhysics {
    ...
    public static void init() {
        Loggers.log("Initializing Garden API");
        setupEFX();
        Loggers.log("EFX ready");

        minecraft = Minecraft.getInstance();
        profiler = new TaskProfiler("Garden API");
    }
