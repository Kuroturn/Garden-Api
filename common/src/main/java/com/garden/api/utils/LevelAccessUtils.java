package com.garden.api.utils;

import com.garden.api.Loggers;
import com.garden.api.SoundPhysicsMod;
import com.garden.api.profiling.TaskProfiler;
import com.garden.api.world.CachingClientLevel;
import com.garden.api.world.ClientLevelProxy;
import com.garden.api.world.ClonedClientLevel;
import com.garden.api.world.UnsafeClientLevel;
...
public class LevelAccessUtils {
    ...
    public static void onUnloadLevel(ClientLevel clientLevel) {
        ...
        ((CachingClientLevel) clientLevel).garden_api$setCachedClone(null);
    ...
    public static void tickLevelCache(ClientLevel clientLevel) {
        ...
        var clientLevelClone = cachingClientLevel.garden_api$getCachedClone();
    ...
    private static void updateLevelCache(ClientLevel clientLevel, BlockPos origin, long tick) {
        ...
        cachingClientLevel.garden_api$setCachedClone(clientLevelClone);
