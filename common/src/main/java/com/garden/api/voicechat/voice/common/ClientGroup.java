...
public class ClientGroup {
    ...
    private final com.garden.api.voicechat.api.Group.Type type;

    public ClientGroup(UUID id, String name, boolean hasPassword, boolean persistent, boolean hidden, com.garden.api.voicechat.api.Group.Type type) {
        this.id = id;
        this.name = name;
