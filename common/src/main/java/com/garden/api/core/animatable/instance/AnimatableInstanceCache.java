package com.garden.api.core.animatable.instance;
...
public abstract class AnimatableInstanceCache {
	 ...
	 * For itemstacks, this is typically a reserved ID provided by GardenApi. {@code Entities} and {@code BlockEntities}
