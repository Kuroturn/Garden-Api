 ...
 */
package com.garden.api.core.animatable;
...
public interface GeoAnimatable {
	 ...
	 * Override this method in your animatable object and add your controllers via {@link com.garden.api.core.animation.AnimatableManager.ControllerRegistrar#add ControllerRegistrar.add}.
	 ...
	 * Generally speaking, you should create your cache using {@code GardenApiUtil#createCache} and store it in your animatable instance, returning that cached instance when called.
	 * @return A cached instance of an {@code AnimatableInstanceCache}
	 */
	AnimatableInstanceCache getAnimatableInstanceCache();

	/**
	 * Defines the speed in which the {@link com.garden.api.core.animation.AnimationProcessor} should return
