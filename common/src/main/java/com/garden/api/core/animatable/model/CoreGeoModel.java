package com.garden.api.core.animatable.model;
...
public interface CoreGeoModel<E extends GeoAnimatable> {
	 ...
	 * @param animatable The {@code GeoAnimatable} instance currently being rendered
	 * @param animTime The internal tick counter kept by the {@link com.garden.api.core.animation.AnimatableManager manager} for this animatable
	 */
